...
import info.androidhive.slidingmenu.ServerUtilities;
...
@SuppressLint("NewApi")
public class MainActivity extends FragmentActivity implements SearchFragment.OnQueryTextListener {
	...
	private void displayView(int position) {
		...
		case 0:
			...
			break;
		case 1:
			fragment = new ShoppingListFragment();//shoppinlist
			break;
		case 2:
			fragment = new CookingTipsFragment();//cooking tip
			break;
		case 3:
			fragment = new HistoryOfFridgeFragment();//history of fridge
			break;
		case 4:
